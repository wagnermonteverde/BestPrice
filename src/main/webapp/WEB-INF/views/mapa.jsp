...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="<c:url value='/resources/css/img/favicon.png'/>">
	<link href="http://fonts.googleapis.com/css?family=Open+Sans:600" type="text/css" rel="stylesheet" />
    <link href="<c:url value='/resources/css/estilomapa.css'/>" type="text/css" rel="stylesheet" />
      
	
	 <script type="text/javascript" src="http://maps.googleapis.com/maps/api/js?sensor=false"></script>
     <script type="text/javascript" src="<c:url value='/resources/js/jquery.min.js'/>"></script>
      <script type="text/javascript" src="<c:url value='/resources/js/boot.min.js'/>"></script>
     
     <script type="text/javascript" src="<c:url value='/resources/js/mapalocendereco.js'/>"></script>
          ...
          <div class="row">
           <div class="col-lg-10">
	        ...
	        <span class="input-group-btn">
                <input class="form-control btn-success" type="button" id="btnEndereco" name="btnEndereco" value="Mostrar no mapa" />
              </span>
               </div><!-- /input-group -->
                 </div><!-- /.col-lg-6 -->
